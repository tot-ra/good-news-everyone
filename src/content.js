...
export const places = [
  ...
  },
  {
    ...
    lng: 35.01944444,
    description:
      "Точное местоположение библейской Аримафеи неизвестно. Одну из распространённых локализаций связывают с современным Рантисом, селением к северо-западу от Иерусалима, но это отождествление остаётся предположительным.",
    photos: []
  },
  {
    id: "emmaus",
